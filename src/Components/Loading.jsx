...
function Loading() {
    return (
        <div className="h-screen justify-center align-middle mt-60 text-center  ">
            <h1 type="button" className="focus:shadow inline-flex cursor-pointer items-center justify-center rounded text-xs font-bold uppercase tracking-widest text-gray-500 transition-all duration-200 ease-in-out">
